...
use AppBundle\Form\RestPostType;
...
class PostRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('AppBundle:Post')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                return $entities;
            }
    ...
    {
        $entity = new Post();
        $form = $this->createForm(get_class(new RestPostType()), $entity, array("method" => $request->getMethod()));
